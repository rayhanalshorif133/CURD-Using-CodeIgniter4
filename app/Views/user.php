  ...
  <section class="content">
    <div class="container">
      <div class="d-flex justify-content-between">
        <h1>User Table</h1>
        <a href="/user/create" class="mt-3"><button class="btn btn-primary btn-sm">Create User</button></a>
      </div>
            ...
            <tr>
              ...
              <td>
                <div class="btn-group" role="group" aria-label="Basic outlined example">
                  <a href="/user/<?php echo $user->id; ?>" class="btn btn-outline-primary btn-sm">View</a>
                  <a href="/user/<?php echo $user->id; ?>/edit" class="btn btn-outline-info btn-sm">Edit</a>
                  <a href="/user/<?php echo $user->id; ?>" class="btn btn-outline-danger btn-sm">Delete</a>
                </div>
              </td>
            </tr>
          <?php endforeach; ?>
