    ...
    <div class="container">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">Phone: <?php echo $user->phone; ?></h6>
          <h6 class="card-subtitle mb-2 text-muted">Address: <?php echo $user->address; ?></h6>
          <a href="/user/<?php echo $user->id; ?>/edit" class="card-link btn">
